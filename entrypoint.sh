...
# The "-o nonempty" option allows mounting over a directory that already contains files.
...
# Ensure that the required directories exist inside the mounted bucket
